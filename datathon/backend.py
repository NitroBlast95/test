...
@app.route('/')
def index():
    return render_template('test/datathon/templates/datathon.html')  # Load datathon.html for the root page

@app.route('/commit')
def commit():
    return render_template('test/datathon/templates/commit.html')  # Load commit.html when visiting /commit route

@app.route('/pull')
def pull():
    return render_template('test/datathon/templates/pull.html')  # Load pull.html when visiting /pull route
